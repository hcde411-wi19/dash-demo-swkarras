    ...
    dcc.Graph(
        ...
        figure={
            ...
            'data': [
                ...
                {'x': weekday_in_order, 'y': ped_n, 'type': 'bar', 'name': 'North Ped'},
                {'x': weekday_in_order, 'y': ped_s, 'type': 'bar', 'name': 'South Ped'},
                {'x': weekday_in_order, 'y': bike_n, 'type': 'bar', 'name': 'North Bike'},
                {'x': weekday_in_order, 'y': bike_s, 'type': 'bar', 'name': 'North Bike'},
